<?php
    ...
    class Elementos{
        ...
        public function Insertar_Elementos($descripcion,$serial,$modelo,$codigoestado,$observacion,$codigotipo){
            $conexion=new Conexion();
            $conx = $conexion->Conectar();
            $sql = "INSERT INTO elementos values(null,'$descripcion','$serial','$modelo',$codigoestado,'$observacion',$codigotipo)";
        ...
        public function Actualizar_Elemento($cod,$descripcion,$serial,$modelo,$codigoestado,$observacion,$codigotipo){
            $conexion=new Conexion();
            $conx = $conexion->Conectar();
            $sql="UPDATE elementos SET e_descripcion='$descripcion',e_serial='$serial',e_modelo='$modelo',ee_cood=$codigoestado,e_observacion='$observacion',te_cood=$codigotipo WHERE e_cod=$cod";
